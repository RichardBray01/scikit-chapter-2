...
# ]
param_grid = [
    { 'n_estimators': [3], 'max_features': [2,4]},
    { 'bootstrap': [False], 'n_estimators': [3], 'max_features': [2,3]}
]
...
sorted_attribs = sorted(zip(feature_importances, attributes), reverse=True)
print ("feature importances:")
for i in sorted_attribs:
    print(i)
